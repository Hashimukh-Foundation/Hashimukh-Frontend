    ...
    <div className="w-full max-w-sm bg-white rounded-lg shadow-md overflow-hidden m-3 flex-shrink-0">
      ...
      <div className="p-6">
        ...
        <button
          ...
          className="w-full py-3 px-4 bg-white border-2 border-[#00df9a] text-[#00df9a] font-medium rounded-md hover:bg-teal-50 transition-colors duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#00df9a] focus:ring-offset-2"
          type="button"
